...
def test_team_attack_kills():
    ...
    athena.add_armor(socks)
    team_two.add_hero(athena)
    assert team_one.heros[0].kills == 0
    team_one.attack(team_two)
    assert team_one.heros[0].kills == 1
...
def test_team_attack_deaths():
    ...
    athena.add_armor(socks)
    team_two.add_hero(athena)
    assert team_two.heros[0].deaths == 0
    team_one.attack(team_two)
    assert team_two.heros[0].deaths == 1
